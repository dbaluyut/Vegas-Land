...
router.get("/happy_hr", async (req, res) => {
  const happy_hr = await conn.raw(`select locations.lat, locations.lng, galleries.image, happy_hr.day, happy_hr.id, happy_hr.happy_hr_start, happy_hr.happy_hr_stop, venues.title from happy_hr 
